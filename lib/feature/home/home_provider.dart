...
import 'package:flutter_firebase_news_app/product/models/recomanded.dart';
...
class HomeNotifier extends StateNotifier<HomeState> with FirebaseUtility {
  ...
  Future<void> fetchRecommended() async {
    final items = await fetchList<Recommended, Recommended>(const Recommended(), FirebaseCollections.recommended);
...
class HomeState extends Equatable {
  ...
  @override
  List<Object?> get props => [isLoading, news, tags, recommended, selectedTag];
